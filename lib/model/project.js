...
exports.Project = function(redis, github) {
    ...
    this.add = function(token, username, repo, done) {
        ...
        async.parallel({
            ...
            addApartment: function addProject(callback) {
    ...
    this.remove = function(token, username, repo, done) {
        async.parallel({
            removeUser: function addUser(callback) {
                redis.srem('projects:' + repo + ':users', username, callback);
            },
            removeApartment: function addApartment(callback) {
    ...
    this.sync = function(token, username, repo, done) {
        ...
        async.auto({
            ...
            addHooks: ["fetchConfig", function addHooks(callack, res) {
                self.addHooks(token, username, repo, res.fetchConfig, callack);
            }],
